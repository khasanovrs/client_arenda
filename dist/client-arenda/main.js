...
var AppComponent = /** @class */ (function () {
    function AppComponent(globalParams, authService, router) {
        ...
        this.checkAuth = this.authService.getEmittedValue().subscribe(function (item) { return _this.checkAuth = item; });
